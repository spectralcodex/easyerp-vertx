...
public class TbPropertyAmenity extends TableImpl<TbPropertyAmenityRecord> {
    ...
    private static final long serialVersionUID = 2063980455;
     ...
     */
    public final TableField<TbPropertyAmenityRecord, Long> ID = createField("id", org.jooq.impl.SQLDataType.BIGINT.nullable(false).defaultValue(DSL.field("nextval('tb_property_amenity_id_seq'::regclass)", org.jooq.impl.SQLDataType.BIGINT)), this, "");

    /**
     * The column <code>public.tb_property_amenity.serialNumber</code>.
     */
    public final TableField<TbPropertyAmenityRecord, String> SERIALNUMBER = createField("serialNumber", org.jooq.impl.SQLDataType.VARCHAR(255).nullable(false), this, "");

    /**
     * The column <code>public.tb_property_amenity.amenity</code>.
     */
    public final TableField<TbPropertyAmenityRecord, String> AMENITY = createField("amenity", org.jooq.impl.SQLDataType.VARCHAR(255), this, "");

    /**
     * The column <code>public.tb_property_amenity.status</code>.
     */
    public final TableField<TbPropertyAmenityRecord, String> STATUS = createField("status", org.jooq.impl.SQLDataType.VARCHAR(5), this, "");

    /**
     * The column <code>public.tb_property_amenity.createdOn</code>.
     */
    public final TableField<TbPropertyAmenityRecord, Timestamp> CREATEDON = createField("createdOn", org.jooq.impl.SQLDataType.TIMESTAMP.nullable(false).defaultValue(DSL.field("CURRENT_TIMESTAMP", org.jooq.impl.SQLDataType.TIMESTAMP)), this, "");

    /**
     * The column <code>public.tb_property_amenity.createdBy</code>.
     */
    public final TableField<TbPropertyAmenityRecord, String> CREATEDBY = createField("createdBy", org.jooq.impl.SQLDataType.VARCHAR(255).nullable(false), this, "");
    ...
    public List<Index> getIndexes() {
        return Arrays.<Index>asList(Indexes.TB_PROPERTY_AMENITY_PKEY);
    }
